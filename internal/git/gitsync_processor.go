...
func cloneRepo(ctx context.Context, path string, repo *v1alpha1.RepositoryPath, authMethod transport.AuthMethod) (*git.Repository, error) {
...
func NewGitSyncProcessor(ctx context.Context, gitSync *v1alpha1.GitSync, kubeClient kubernetes.Client, clusterName string) (*GitSyncProcessor, error) {
	...
	go func(repo *v1alpha1.RepositoryPath) {
		...
		r, err := cloneRepo(ctx, localRepoPath, repo, method)
		if err != nil {
