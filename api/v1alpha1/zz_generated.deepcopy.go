...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MultiClusterFile) DeepCopyInto(out *MultiClusterFile) {
	*out = *in
	out.GitLocation = in.GitLocation
	if in.RepoCredential != nil {
		in, out := &in.RepoCredential, &out.RepoCredential
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MultiClusterFile.
func (in *MultiClusterFile) DeepCopy() *MultiClusterFile {
	if in == nil {
		return nil
	}
	out := new(MultiClusterFile)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MultiClusterFileGenerator) DeepCopyInto(out *MultiClusterFileGenerator) {
	*out = *in
	if in.Files != nil {
		...
		*out = make([]*MultiClusterFile, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(MultiClusterFile)
...
func (in SingleClusterGenerator) DeepCopyInto(out *SingleClusterGenerator) {
	{
		in := &in
		*out = make(SingleClusterGenerator, len(*in))
